...
# Use %NMINCLUDE% instead of $(NMINCLUDE). This saves 34 bytes on my system, which is enough to bring pthread4w command line below 4096 bytes!
LIB2LIBS_CMD=cmd /c "set "LIBS=$(LIBS)" & set "LIB=$(LIB)" & set "O=$(O)" & set "_OBJECTS=$(_OBJECTS)" & "%NMINCLUDE%\lib2libs.bat" >$(LIB2LIBS_MAK)"
